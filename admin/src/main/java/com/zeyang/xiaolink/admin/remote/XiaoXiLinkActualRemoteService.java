...
package com.zeyang.xiaolink.admin.remote;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.zeyang.xiaolink.admin.config.OpenFeignConfiguration;
...
@FeignClient(
        value = "xioaxi-link-project",
        url = "${aggregation.remote-url:}",
        configuration = OpenFeignConfiguration.class
)
public interface XiaoXiLinkActualRemoteService {
     ...
     * @return 短链接创建响应
     */
    @PostMapping("/api/xiaoxi-link/v1/create")
